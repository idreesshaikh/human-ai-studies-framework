...
| FR-LIT-8 | owner elicitation 2026-07-17; FR-CONV-2, FR-TPL; D8, D36 | `scripts/corpus_harvest.py` + `docs/papers/corpus-index.json`/`CORPUS.md`; importer pending | pipeline 2026-07-17; importer MP-15 | 🔶 pipeline + verified committed run (900 Tier B + 100 seeds = 1,000; `--verify` 900/900 identical vs live API; F8.1/F8.3 met); importer pending |
| FR-LIT-9 | owner elicitation 2026-07-17; FR-CONV-2; RQ-F4 | paper matcher (FTS→LLM ladder) + recommendation cards | MP-15 (spec `docs/roadmap/15-...`) | 🔶 slice 1: recommendation cards (dealt-card tilt) from deterministic stub incl. F9.1 demo; real match ladder slice 2 |
...
| FR-CONV-1 | S7; RQ-F4; owner elicitation 2026-07-17; arXiv:2507.02564, arXiv:2603.04244 | design conversation (platform/ app + middleware threads) | MP-15 slice 1 (spec `docs/roadmap/15-templates-and-conversational-designer.md`) | 🔶 slice 1: `platform/` surface + deterministic no-LLM stub (move cards, streaming turns, draft rail); server threads slice 4 |
| FR-CONV-2 | RQ-F4; FR-ETH-4 mechanism; arXiv:2312.10893 | grounding contract (cite-what-you-retrieved) | MP-15 (spec `docs/roadmap/15-...`) | 🔶 slice 1: grounding chips + unsourced labels rendered from stub; real cite-what-you-retrieved retrieval slice 2/4 |
| FR-CONV-3 | RQ-F1, RQ-F4; NFR-6 | deterministic move→YAML compiler + diff approval | MP-15 (spec `docs/roadmap/15-...`) | 🔶 slice 1: client-side LLM-free compiler stub (accepted moves → draft rail); server compiler + approval audit slice 4 |
