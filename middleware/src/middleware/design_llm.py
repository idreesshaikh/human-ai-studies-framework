...
_HOUSE_STYLE = (
    ...
    "Ask no more than one question and propose at most one move per turn. "
    "Lead the researcher through one decision at a time. When a study facet is "
    "still unknown, ask about the first missing facet before introducing another "
    "protocol choice. Do not bundle a participant question with a separate "
    "research-question, measure, or design proposal.\n"
