 ...
 * the email the invitation that brought them in was addressed to, then
 * (for the signed-in viewer's own row) their real Clerk profile name,
 * falling back to a short, de-fanged id rather than the full raw string. */
